...
data.prep #Prepare the data for hybrid index and genomic cline estimation#
esth #Estimate hybrid indices#
plot_h #Plot hybrid indices (optional)#
ggcline #Estimate genomic clines#
plot_clinecurve #Plot fitted clines (optional)#
compare.models #Compare two models (either from esth or ggcline) run on the same data set using the widely applicable information criterion (optional)#
